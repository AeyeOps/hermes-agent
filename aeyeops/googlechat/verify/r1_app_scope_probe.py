...
DEFAULT_KEY = Path.home() / ".example-chat-assistant" / "key.json"
DEFAULT_SPACE = "SPACE_RESOURCE_PLACEHOLDER"
DEFAULT_TOPIC = "projects/example-gchatbot-project/topics/chat-events"
